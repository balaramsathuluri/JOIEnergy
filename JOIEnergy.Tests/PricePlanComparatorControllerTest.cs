...
namespace JOIEnergy.Tests
{
    public class PricePlanComparatorControllerTest
    {
        ...
        private readonly Mock<ILogger<PricePlanComparatorController>> _mockLogger;
        ...
        public PricePlanComparatorControllerTest()
        {
            ...
            _mockLogger = new Mock<ILogger<PricePlanComparatorController>>();

            _controller = new PricePlanComparatorController(
                _mockPricePlanService.Object,
